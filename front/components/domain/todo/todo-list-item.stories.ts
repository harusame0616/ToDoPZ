...
export default {
  title: 'Domain/Todo/TodoListItem',
...
const Template: Story = (args) => ({
  ...
  setup() {
    ...
    provide(injection, useTodoList({ todos: [args.todo] }));
  ...
  template:
    '<TodoListItem :injection="injection" :expand="expand" :index="0" />',
});
...
export const OpenBlank = Template.bind({});
OpenBlank.args = {
  todo: {
    title: '',
    note: '',
...
export const NoExpand = Template.bind({});
NoExpand.args = {
  todo,
  expand: false,
};
