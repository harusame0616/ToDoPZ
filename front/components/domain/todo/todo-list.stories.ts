...
const Template: Story = (args) => ({
  ...
  setup() {
    ...
    provide(injection, useTodoList(args.todoList));
  ...
  template: `<TodoList :injection="injection" v-model:selectIndex="selectIndex">test</TodoList>`,
});

export const Empty: Meta = Template.bind({});
Empty.args = {};

const todoList = {
  todos: [
    { title: 'Todo1', note: 'note note' },
    { title: '', note: 'note note' },
    {
      title: 'item3',
      note: `吾輩わがはいは猫である。名前はまだ無い。
...
export const NoExpand: Meta = Template.bind({});
NoExpand.args = {
  todoList,
  selectIndex: -1,
};

export const Open: Meta = Template.bind({});
Open.args = {
  todoList,
  selectIndex: 2,
};
